...
var slide_hero = new Swiper(".slide-principal", {
  ...
  const menuMobile = document.querySelector('.left-container nav')
  const modalHidden = document.querySelector('.right-container');

  btnMobile.addEventListener('click', (event) => {
   event.preventDefault();

      menuMobile.classList.add('active');
      modalHidden.classList.add('menu-hidden');

      menuMobile.addEventListener('mouseleave', () => { 
         menuMobile.classList.remove('active');
         modalHidden.classList.remove('menu-hidden');
